...
if __name__ == '__main__':
    list_of_video_names = os.listdir("../data/video_train_copy")
    ...
    for video_name in list_of_video_names:
        ...
        video_reading_path = "../data/video_train_copy/" + video_name
        print(video_reading_path)

        # 2. Set the path to store the extracted audio clip.
        audio_storing_path = "../data/audio_adrian/" + video_name[:-4] + ".wav"
